      ...
      <div class="container-fluid">
        ...
        <?php
            if(isset($_SESSION['nombre_usuario'])) {
                ...
                echo '<li class="active"><a href="carrito.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> '.$_SESSION['nombre_usuario'].'<span class="sr-only">(current)</span></a></li>';
                echo '</ul>';
                ...
                if($resultado_array[0] == 0) {
                    echo '<ul class="nav navbar-nav">';
                    echo '<li class="active"><a href="#"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Ir al carrito<span class="sr-only">(current)</span></a></li>';
                    echo '</ul>';
                }
            }
            else {
            ...
            <div class="row">
                <div class="col col-md-4 col-md-offset-4">
                    ...
                    <?php
                        ...
                        if($resultado_array[0] != 0)
                        {
                            echo "<div class='alert alert-danger' role='alert'>El nombre de usuario ya existe. Intente insertando otros datos.</div>";
