    ...
    <div class="container">
      <div class="row">
        <div class="col col-md-4 col-md-offset-4">
          ...
          $vModificacion = "update bebidas set nombre = '$nombre', precio='$precio',detalle ='$detalle' ,descripcion='$descripcion', marca='$marca', id_tipo_bebida ='$tipo_bebida' where id_bebida = '$ID_Bebida' ";
